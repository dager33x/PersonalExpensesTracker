...
import { ArcjetErrorDecision, ArcjetErrorReason, ArcjetRuleResult, ArcjetReason, ArcjetDenyDecision, ArcjetBotReason, ArcjetPromptInjectionReason, ArcjetSensitiveInfoReason, ArcjetFilterReason, ArcjetRateLimitReason, ArcjetShieldReason, ArcjetEmailReason } from '@arcjet/protocol';
...
function arcjet(options) {
    ...
    async function protect(rules, ctx, request) {
        ...
        if (rules.length > 10) {
            ...
            client.report(context, reportDetails, decision, 
